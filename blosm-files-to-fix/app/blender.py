...
class BlenderApp(BaseApp):
    ...
    osmServers = {
        "overpass-api.de-NEW2": "http://lz4.overpass-api.de",
        "overpass-api.de-NEW": "http://z.overpass-api.de",
        "overpass-api.de": "http://overpass-api.de",
        "VK Maps": "https://maps.mail.ru/osm/tools/overpass",
        "overpass-api.ru": "http://overpass.openstreetmap.ru",
        "openstreetmap.fr": "http://overpass.openstreetmap.fr",
        "openstreetmap.tw": "http://overpass.nchc.org.tw",
    ...
    def buildTerrain(self, verts, indices, heightOffset):
		...
		# 4CAST: My Value to fix clamp to ground
        minHeight = 0
