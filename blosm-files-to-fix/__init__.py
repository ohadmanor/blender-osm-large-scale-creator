...
class BlosmPreferences(bpy.types.AddonPreferences, ape.AssetPackageEditor):
    ...
    osmServer: bpy.props.EnumProperty(
        ...
        items = (
            ("overpass-api.de-NEW2", "lz.overpass-api.de: 4 cores, 64 GB RAM", "lz.overpass-api.de: 4 cores, 64 GB RAM"),
            ("overpass-api.de-NEW", "z.overpass-api.de: 4 cores, 64 GB RAM", "z.overpass-api.de: 4 cores, 64 GB RAM"),
            ("overpass-api.de", "overpass-api.de: 8 cores, 128 GB RAM", "overpass-api.de: 8 cores, 128 GB RAM"),
            ("overpass-api.ru", "overpass-api.ru: 8 cores, 64 GB RAM", "overpass-api.ru: 8 cores, 64 GB RAM"),
            ...
            ("openstreetmap.tw", "openstreetmap.tw: 8 cores, 16 GB RAM", "openstreetmap.tw: 8 cores, 16 GB RAM"),
